<html>
	<head>
		...
		<style>
			...
			header
			{
				background-image:url("images/bannerbike2.jpg");
	...
	<body>
		...
		<div class="head">
			...
			<br>    
            <font>We provides car on rent for conferences and boared meeting in Mumbai</font>
        </div>
        </header>
        <br> <br> <br >
        ...
        <h1 style="font-size:1.6vw;margin:0 0 0 50%;">CONFERANCE AND BOARED MEETINGS</h1>
       	<p class="main" style="margin:2% 0 0 50%;">
            We provides car on rent for conferences and boared meeting in Mumbai
