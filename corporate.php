<html>
	...
	<body>
        ...
        <p style="color:grey;font-size:1.2vw;text-align:left;margin:20px 80px 0 52%">
            Car Bike Rental Hub provides <i>Corporate Travel Management</i> or company cars, a concept adopted by a 
			majority of  companies for better cost management for their travel requirements.<br><br>
			<b>Commercial Vehicle Leasing In maharashtra, Business Car Rentals In maharashtra, Corporate Car Rentals In maharashtra, 
			Innova Hire In maharashtra.</b>
        </p></div>
		<div class="ccr1">
