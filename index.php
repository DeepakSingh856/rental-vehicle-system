<html>
	...
	<body>
		<div class="up" id="up">
			<div class="logo">
				<img src="images/logo.png" height="120%" width="13%" style="float:left;margin:-1.2% 0 0 6.5%;">
				<a href="login.php">
        			<button style="border-radius: 5px;height: 40px;width: 90px;">Login</button>
    			</a>
				<a href="signup.php">
        			<button style="border-radius: 5px;height: 40px;width: 100px;">Sign up</button>
    			</a>
				<img style="height: 35px; width: auto; margin-left: 10px;" src="images/user.png" >
			</div>
			
			<!-- <img height="25%" width="1.6%" src="images/phone.png" style="height:auto;"><font style="font-size:1.254vw;">&ensp;+91-9892908723&emsp;</font>
			<img height="21%" width="1.9%" src="images/message.png" style="height:auto;"><font style="font-size:1.254vw;">&ensp;Info@carbikerental.in</font></div> -->
			<!-- <div class="logo1"><center><img  src="images/logo.png" height="50%" width="30%"></center>
					<div class="call"><img height="25%" width="2.5%" src="images/phone.png" style="height:auto;"><font>+91-9892908723&emsp;</font></div>
					<div class="mail"><img height="21%" width="2.5%" src="images/message.png" style="height:auto;"><font>&ensp;Info@carbikerental.in</font></div></div> -->
			<nav>
				<ul>
					...
					<li><div class="dropdown">
                        <a id="glow3" class="navi" href="index.php#service" style="margin-left:11px;">Service</a>
			...
			<table  style="width:82%;margin:auto;">
				<tr>
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">car bike rentak hub offers to make it easy for clients to get the right car at
							 the right price at the right time. If you are looking for car rental service in Maharashtra/India or minibusses hire 
							 services, then our company is the right option for you. Get the best deal on booking of luxury car and coaches in Maharashtr.</h3>
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">car bike rental hub is emerging car rental company in delhi/india . We have been known in industry 
							for our 100% customer satisfaction. We think for a special occasion we need the right car at right prices, car bike retal hub  provides 
				...
				<tr>
					<td>
						<img src="images/event0.jpg" style="float:left;"><h1 style="font-size:1.4vw;color:black;">EVENT TRANSPORTATION</h1>
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">car bike rental hub is a very customer friendly company where customer service and
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">car bike rental hub is providing One Way Drop Services From maharashtra / mumbai, We offer 
							to make it easy for clients to get the right car at the right price at the right time. If you are looking for 
							car rental service in maharashtra/India, we are the right choice for you.</h3>
        ...
        <footer>
			<table style="height:10%;">
				...
				<tr bgcolor="#252525">
					<td class="widget">
						<p class="text">Car Bike Rental Hub is one of the reputed Travel<br>
						Company in India.At car bike rental hub<br>
						everything we do is about giving you the<br>
						freedom to discover more.</p>
					</td>
					<td class="widget">
						<p class="text1">Address:Mumbai, maharashtra,India<br>
						<img src="images/phone.png">&emsp;+91-9892908723<br>
						<img src="images/message.png">&emsp;carbikerental123@gmail.com</p>
					</td>
				</tr>
				<tr bgcolor="black">
