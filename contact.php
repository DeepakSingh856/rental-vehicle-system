<html>
	...
	<body onload="Display()">
		...
		<iframe id="Sticky" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1180.3284516164863!2d72.8503545785826!3d19.098719555804404!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c84cb514c175%3A0x56bd843df0e5b97b!2sM.L.%20Dahanukar%20College%20of%20Commerce!5e0!3m2!1sen!2sus!4v1738478343675!5m2!1sen!2sus" 
		...
		<table class="form" id="registration">
			...
			<tr>
			<td style="padding-right: 20px;">Issue Date: <input type="date" name="date" id="date" onchange="CheckDate()" style="margin-left:5%;"></td>
			...
			<tr>
			<td >Return Date: &nbsp;&nbsp;&nbsp;<input type="date" name="date" id="date" onchange="CheckDate()" style="margin-right:5%;"></td>
			</tr>
			...
			<table class="main" background="images/contact.jpg">
				<tr>
					<td class="contact">
						...
						<p>Car bike rental hub (vile parle (E))</p>
					</td>
					<td class="contact">
						<h4>Contact By Email</h4>
						<p>Info@carbikerental.in</p>
					</td>
					<td class="contact">
		...
		<?php
			...
			{	
				...
				$username = "Sonam Vishwakarma";
				$password = "password";
				$dbname = "Sonam Vishwakarma";
				// Create connection
